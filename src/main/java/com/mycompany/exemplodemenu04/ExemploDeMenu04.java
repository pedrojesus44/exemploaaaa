 ...
 */
package com.mycompany.exemplodemenu04;
...
public class ExemploDeMenu04 extends JFrame {
    JMenuBar barra;
    ...
    public ExemploDeMenu04() {
        super("Exemplo e Menus com JRadioButtonMenuItem");
...
public static void main (String args[]) {
    ExemploDeMenu04 app = new ExemploDeMenu04();
